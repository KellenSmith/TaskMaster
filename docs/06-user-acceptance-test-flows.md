...
6. Create a new member with the following details:
    - Email: [Use a valid email address]
    - Nickname: "eventReserve"
    - Role: "member"
7. Validate all members' memberships.
8. Assign all members a membership.
9. Print the members list
...
3. Upload a document to the organization documents section.
4. Fill in the event manager email.
5. Save the changes.
6. Go to the calendar page and create a new event.
7. Submit the event for approval.
