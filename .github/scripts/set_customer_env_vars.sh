...
NEXT_PUBLIC_ORG_NAME=$(extract_json_value "$CUSTOMER_VARS_JSON" 'NEXT_PUBLIC_ORG_NAME')
...
NEXT_PUBLIC_TIMEZONE=$(extract_json_value "$CUSTOMER_VARS_JSON" 'NEXT_PUBLIC_TIMEZONE' true)
...
add_customer_var_to_environments "NEXT_PUBLIC_TIMEZONE" "$NEXT_PUBLIC_TIMEZONE"
