...
import { DEFAULT_REMIND_MEMBERSHIP_EXPIRES_IN_DAYS } from "../../lib/membership-utils";
...
export const expiringMembershipMaintenance = async (): Promise<void> => {
    ...
    const orgSettings = await getOrganizationSettings();
    const reminderDays =
        orgSettings?.remind_membership_expires_in_days || DEFAULT_REMIND_MEMBERSHIP_EXPIRES_IN_DAYS;
